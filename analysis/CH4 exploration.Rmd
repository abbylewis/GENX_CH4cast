...
QUESTIONS:
- What is time2 vs. flux_timestamp?
- Time2 is said to be UTC. What time zone are sunrise and sunset?
- Any thoughts on funky methane data in ambient/0.75 in 2021?
- Wind data?
...
Initial plots
Note that temperature treatments appear to start the second year
...
No- the main difference is between years rather than between treatments
